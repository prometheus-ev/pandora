...
Ajax.Autocompleter = Class.create(Autocompleter.Base, {
  ...
  getUpdatedChoices: function() {
    ...
    if (meta) {
      this.options.requestHeaders = {'X-CSRF-Token': meta.content};
    }
...
Ajax.InPlaceEditor = Class.create({
  ...
  enterEditMode: function(e) {
    ...
    if (this.options.elementHideClass) this.element.addClassName(this.options.elementHideClass);
  ...
  leaveEditMode: function() {
    ...
    if (this.options.elementHideClass) this.element.removeClassName(this.options.elementHideClass);
