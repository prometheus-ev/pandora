class Indexing::Sources::Cvma < Indexing::SourceSuper
  def records(file)
  ...
  def location_nested
    ...
    @location = record['Iptc4xmpExt:LocationCreated']['Iptc4xmpExt:Sublocation']
    ...
    name = "#{world_region}, #{country}, #{province}, #{@city}, #{@location} (#{latitude}, #{longitude})" 
